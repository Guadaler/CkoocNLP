...
public class Record {
	...
	public String getRecordDecisionClass() {
		...
		value = attrValues.get(RoughSets.DECISION_ATTR_NAME);
	...
	public String getDecisionRule(ArrayList<String> reductAttr) {
		...
		decisionValue = attrValues.get(RoughSets.DECISION_ATTR_NAME);
		ruleStr += "属性";
		for (Map.Entry entry : this.attrValues.entrySet()) {
			attrName = (String) entry.getKey();
			value = (String) entry.getValue();

			if (attrName.equals(RoughSets.DECISION_ATTR_NAME)
